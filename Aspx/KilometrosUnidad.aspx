<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KilometrosUnidad.aspx.cs" Inherits="Cool.Aspx_KilometrosUnidad" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Kilometros por Unidad</title>
    <ext:ResourcePlaceHolder ID="rp" runat="server">
        ...
        <script src="../Js/Fn/Fn_KilometrosUnidad.js" type="text/javascript"></script>
    ...
    <ext:Store ID="z_strConsulta" runat="server">
        <Model>
            <ext:Model ID="Model2" runat="server">
                <Fields>
                    <ext:ModelField Name="Unidad" Type="Int"></ext:ModelField>
        ...
        <Sorters>
            <ext:DataSorter Property="Unidad" Direction="ASC"></ext:DataSorter>
        </Sorters>
    </ext:Store>
        ...
        <Items>
            ...
            <ext:GridPanel ID="z_GrdPnl_Detalle" runat="server" StoreID="z_strConsulta" Anchor="100% -103" AutoScroll="true" MarginSpec="3 3 3 3">
                ...
                <ColumnModel ID="ColumnModel1" runat="server">
                    <Columns>
                        <ext:NumberColumn runat="server" Text="N° Unidad" DataIndex="Unidad" Width="75" Align="Center" Format="0"></ext:NumberColumn>
