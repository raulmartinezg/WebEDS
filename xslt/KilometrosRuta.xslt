...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <xsl:template match="/*">
    ...
    <Worksheet ss:Name="Consulta_KilometrosPorRuta">
      <Names>
    ...
    x:FullRows="1" ss:DefaultColumnWidth="60" ss:DefaultRowHeight="15">
        ...
        <Row ss:Height="35.5" ss:Index="1">
          <Cell ss:Index="1" ss:MergeAcross="12" ss:StyleID="s63">
            <Data ss:Type="String">Cargo EDS.</Data>
          </Cell>
        </Row>
        <Row ss:Height="35.5" ss:Index="2">
          <Cell ss:Index="1" ss:MergeAcross="12" ss:StyleID="s64">
            <Data ss:Type="String">Kilómetros por Ruta</Data>
          </Cell>
        </Row>
        ...
        <Row ss:Index="8" ss:AutoFitHeight="0" ss:Height="40">
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">RutaInicial</Data>
            <NamedCell
        ...
        <xsl:for-each select="/records/record">
         ...
         <!-- LL E N A R   D A T O S -->
          <Row>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="String">
                <xsl:value-of select="PrimerRutaCargada" />
              </Data>
      ...
      <AutoFilter x:Range="R8C1:R8C12" xmlns="urn:schemas-microsoft-com:office:excel"></AutoFilter>
    </Worksheet>
  </xsl:template>
</xsl:stylesheet>