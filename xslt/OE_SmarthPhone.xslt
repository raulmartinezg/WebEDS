...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <xsl:template match="/*">
    ...
    <Worksheet ss:Name="UsoSmartPhoneEDS">
      <Names>
        <NamedRange ss:Name="_FilterDatabase" ss:Hidden="1" />
        <NamedRange ss:Name="Print_Titles" ss:RefersTo="Records!R8" />
      </Names>
    ...
    x:FullRows="1" ss:DefaultColumnWidth="60" ss:DefaultRowHeight="15">
        ...
        <Row ss:Height="35.5" ss:Index="1">
          <Cell ss:Index="1" ss:MergeAcross="8" ss:StyleID="s63">
            <Data ss:Type="String">Cargo EDS.</Data>
          </Cell>
        </Row>
        <Row ss:Height="35.5" ss:Index="2">
          <Cell ss:Index="1" ss:MergeAcross="8" ss:StyleID="s64">
            <Data ss:Type="String">Entrega Embarques Sistema "SIDMOVIL"</Data>
          </Cell>
        </Row>
        <Row ss:AutoFitHeight="0" ss:Index="4">
          <Cell ss:Index="8" ss:MergeAcross="1" ss:StyleID="s70">
      ...
      ss:Name="_FilterDatabase"/>
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Embarques SIDTUM</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>

          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Embarques SIDMOVIL</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>

          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Embarques Pendientes</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>

          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Articulos SIDTUM</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>

          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Articulos SIDMOVIL</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>

          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Articulos Pendientes</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>
        ...
        <xsl:for-each select="/records/record">
          ...
          <Row>
            ...
            <Cell ss:StyleID="s187">
              <Data ss:Type="DateTime">
                <xsl:value-of select="concat(substring(Fecha,1,19),'.000')" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="Number">
                <xsl:value-of select="EmbarquesSIDTUM" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="Number">
                <xsl:value-of select="EmbarquesSIDMOVIL" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="Number">
                <xsl:value-of select="EmbarquesPendientes" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="Number">
                <xsl:value-of select="ArticulosSIDTUM" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="Number">
                <xsl:value-of select="ArticulosSIDMOVIL" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
            ...
            <Cell ss:StyleID="s76">
              <Data ss:Type="Number">
                <xsl:value-of select="ArticulosPendientes" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>
