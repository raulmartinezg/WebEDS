...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <xsl:template match="/*">
    ...
    <Worksheet ss:Name="VisitasXRutaXCiudad">
      <Names>
    ...
    x:FullRows="1" ss:DefaultColumnWidth="60" ss:DefaultRowHeight="15">
        ...
        <Row ss:Height="35.5" ss:Index="1">
          <Cell ss:Index="1" ss:MergeAcross="14" ss:StyleID="s63">
            <Data ss:Type="String">Cargo EDS</Data>
          </Cell>
        </Row>
        <Row ss:Height="35.5" ss:Index="2">
          <Cell ss:Index="1" ss:MergeAcross="14" ss:StyleID="s64">
            <Data ss:Type="String">Visitas Por Ruta y Ciudad</Data>
          </Cell>
        </Row>
        <Row ss:AutoFitHeight="0" ss:Index="4">
          <Cell ss:Index="8" ss:MergeAcross="7" ss:StyleID="s70">
        ...
        <Row ss:Index="8" ss:AutoFitHeight="0" ss:Height="40">
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">ClaveRuta</Data>
            <NamedCell
      ...
      ss:Name="_FilterDatabase"/>
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Secuencia</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>
      ...
      <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
        <PageSetup>
          ...
          <Footer x:Margin="0.78740157480314965"
					 x:Data="&amp;Z&amp;&quot;Arial,Negrita&quot;&amp;8Confidencial&amp;CPagina &amp;P de &amp;#&amp;D&amp;7Cargo EDS"/>
      ...
      <AutoFilter x:Range="R8C1:R8C15" xmlns="urn:schemas-microsoft-com:office:excel"></AutoFilter>
    </Worksheet>
  </xsl:template>
</xsl:stylesheet>