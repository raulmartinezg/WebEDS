...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <xsl:template match="/*">
    ...
    <Worksheet ss:Name="Consulta_EmbarquesPorOperador">
      <Names>
    ...
    x:FullRows="1" ss:DefaultColumnWidth="60" ss:DefaultRowHeight="15">
        ...
        <Row ss:Height="35.5" ss:Index="1">
          <Cell ss:Index="1" ss:MergeAcross="13" ss:StyleID="s63">
            <Data ss:Type="String">Cargo EDS.</Data>
          </Cell>
        </Row>
        <Row ss:Height="35.5" ss:Index="2">
          <Cell ss:Index="1" ss:MergeAcross="13" ss:StyleID="s64">
            <Data ss:Type="String">Embarques Realizados por Operador</Data>
          </Cell>
        </Row>
        <Row ss:AutoFitHeight="0" ss:Index="4">
          <Cell ss:Index="8" ss:MergeAcross="6" ss:StyleID="s70">
        ...
        <Row ss:Index="8" ss:AutoFitHeight="0" ss:Height="40">
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">NumeroOperador</Data>
            <NamedCell
      ...
      ss:Name="_FilterDatabase"/>
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">Operacion</Data>
            <NamedCell
      ss:Name="_FilterDatabase"/>
          </Cell>
