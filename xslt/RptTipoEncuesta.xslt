...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
  ...
  <xsl:template match="/*">
    ...
    <Worksheet ss:Name="RptTipoEncuesta">
      <Names>
    ...
    x:FullRows="1" ss:DefaultColumnWidth="60" ss:DefaultRowHeight="15">
        ...
        <Column ss:AutoFitWidth="1" ss:Width="130"/>
        <Column ss:AutoFitWidth="1" ss:Width="290"/>
        <Column ss:AutoFitWidth="1" ss:Width="130"/>
        ...
        <Row ss:Height="35.5" ss:Index="2">
          <Cell ss:Index="1" ss:MergeAcross="6" ss:StyleID="s64">
            <Data ss:Type="String">Tipo Encuesta por Concesionario</Data>
          </Cell>
        </Row>
        <Row ss:AutoFitHeight="0" ss:Index="4">
          <Cell ss:Index="4" ss:MergeAcross="2" ss:StyleID="s70">
        ...
        <Row ss:Index="5" ss:AutoFitHeight="0" ss:Height="40">          
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">SalidaProgramada</Data>
            <NamedCell  ss:Name="_FilterDatabase"/>
          </Cell>
          <Cell ss:StyleID="s97">
          ...
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">RazonSocial</Data>
            <NamedCell  ss:Name="_FilterDatabase"/>
          </Cell>
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">FechaEncuesta</Data>
            <NamedCell  ss:Name="_FilterDatabase"/>
          </Cell>
          <Cell ss:StyleID="s97">
            <Data ss:Type="String">TipoEncuesta</Data>
            <NamedCell  ss:Name="_FilterDatabase"/>
          </Cell>
        </Row>
		...
		<xsl:for-each select="/ds/records/record"> 
		 ...
		 <Row>
			...
			<Cell ss:StyleID="s187">
			  <xsl:if test = "FechaEncuesta != ''" >
				<Data ss:Type="DateTime">
				  <xsl:value-of select="concat(substring(FechaEncuesta,1,19),'.000')" />
				</Data>
			  </xsl:if>
			  <NamedCell ss:Name="_FilterDatabase" />
			</Cell>	
			<Cell ss:StyleID="s83">
              <Data ss:Type="String">
                <xsl:value-of select="TipoEncuesta" />
              </Data>
              <NamedCell ss:Name="_FilterDatabase" />
            </Cell>				
         </Row>
      ...
      <AutoFilter x:Range="R5C1:R5C8" xmlns="urn:schemas-microsoft-com:office:excel"></AutoFilter>
    </Worksheet>
  </xsl:template>
</xsl:stylesheet>